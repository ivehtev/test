<?php /* Template Name: Страница Саппорт */
get_header();
...
<div class="main main--marketing">
        ...
        <div class="refferals-section">
            <div class="refferals-section__card">
                <div class="refferals-section__img"> <img
                        src="http://sputnik.dev-tmweb.ru/wp-content/themes/sputnik/assets/images/content/photo2.png"
                        alt=""></div>
                <div class="refferals-section__header" style="font-size:23px; margin-bottom:16px">Полезные статьи</div>
                <a class="refferals-section__link" style="
    align-self: flex-start; margin-left:20px" href="<?=$brandbook_link?>">Почитать</a>
            </div>
            <div class="refferals-section__card">
                <div class="refferals-section__img"> <img
                        src="http://sputnik.dev-tmweb.ru/wp-content/themes/sputnik/assets/images/content/example2.png"
                        alt=""></div>
                <div class="refferals-section__header" style="font-size:23px; margin-bottom:16px">Видеоинструкции</div>
                <a class="refferals-section__link" style="
    align-self: flex-start; margin-left:20px" href="<?=$photobank_link?>">Посмотреть</a>
            </div>
            <div class="refferals-section__card">
                <div class="refferals-section__img"> <img
                        src="http://sputnik.dev-tmweb.ru/wp-content/themes/sputnik/assets/images/content/photo1.png"
                        alt=""></div>
                <div class="refferals-section__header" style="font-size:23px; margin-bottom:16px">Обсудить с коллегами
                </div><a class="refferals-section__link" style="
    align-self: flex-start; margin-left:20px" href="<?=$admaterial_linkn?>">Поболтать</a>
            </div>
    ...
    <div class="promote-section">
        <div class="container-bordering">
            ...
            <div class="promote-section__shout"><img
                    src="http://sputnik.dev-tmweb.ru/wp-content/themes/sputnik/assets/images/content/shout.png" alt="">
            </div>
        </div>
    </div>
</div>
